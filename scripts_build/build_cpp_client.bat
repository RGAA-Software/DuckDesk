...
call "%~dp0..\scripts\build_cpp_target.bat" px_client px_rtc_client test_client_imgui_launch_config test_client_input_mapper test_client_instance_guard test_client_local_file_system test_client_file_browser_model test_client_file_transfer_format test_rdp_clipboard_channel
if errorlevel 1 exit /b %errorlevel%
set "PATH=%~dp0..\%CPP_BUILD_DIR%\src\px_deps;%PATH%"
...
if errorlevel 1 exit /b %errorlevel%
"%~dp0..\%CPP_BUILD_DIR%\src\px_client\test_rdp_clipboard_channel.exe"
if errorlevel 1 exit /b %errorlevel%
