...
call "%~dp0..\scripts\build_cpp_target.bat" px_client px_rtc_client test_client_imgui_launch_config test_client_input_mapper test_client_local_file_system test_client_file_browser_model
