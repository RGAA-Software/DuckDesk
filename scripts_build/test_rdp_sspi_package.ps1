...
$env:PATH="$(Join-Path $repoRoot '.cache/rdp_sdk/bin');$env:PATH"
...
public static class SspiPackageProbe {
 ...
 [DllImport("px_rdp_winpr.dll",ExactSpelling=true)] static extern IntPtr InitSecurityInterfaceExW(uint flags);
