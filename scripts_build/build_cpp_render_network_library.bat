...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0..\scripts\publish_cpp_artifacts.ps1" -Component render_network_library -LibraryTarget "%LIBRARY_TARGET%"
exit /b %errorlevel%
