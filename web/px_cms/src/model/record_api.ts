// request device render records (docs/cms_render_records_view_design.md 5.2/5.3/6.3/6.4)
...
// business codes from cms_api_error.rs
export const RECORD_ERR_DEVICE_OFFLINE = 626
export const RECORD_ERR_TIMEOUT = 627

// api error carrying the cms business code (RespMessage.code)
...
// GET /api/v1/record/list?device_id= — cms-side merged list (design 6.3)
...
// POST /api/v1/record/download — save a copy on the cms host, keep=true (design 6.4)
export async function downloadRecordToCms(
  deviceId: string,
  filename: string,
