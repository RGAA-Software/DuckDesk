    ...
    <div class="flex min-h-screen items-center justify-center px-4">
        <div class="cyber-panel cyber-corners w-full max-w-sm p-8">
            <div class="flex flex-col items-center gap-4">
                <img :src="iconLogo" alt="Pixels" class="h-14 w-14" />
                <h1 class="font-tech text-xl font-bold tracking-[0.2em] text-cyber-text">
                    {{ t("admin.loginTitle") }}
                </h1>
                <div class="flex items-center gap-2">
                    <span class="cyber-dot"></span>
                    <span class="font-tech text-[10px] tracking-[0.18em] text-cyber-muted">{{
                        t("admin.restricted")
                    }}</span>
                </div>
            </div>
            ...
            <div class="mt-8 flex flex-col gap-4">
                ...
                <p v-if="errorMsg" class="font-tech text-xs tracking-wider text-cyber-red">
                    {{ errorMsg }}
                </p>
