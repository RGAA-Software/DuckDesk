...
<template>
    ...
    <div>
        ...
        <div class="flex justify-center items-center">
            ...
            <a-button class="ml-2 w-22" type="primary" @click="handleCopyMachineCode"
                >复制</a-button
            >
        </div>
        ...
        <div class="flex justify-center items-center">
            <div class="w-100 flex justify-start items-center">
                ...
                <a-tag class="ml-1" :color="authStatusType" size="small">{{
                    authStatusText
                }}</a-tag>
                <span v-if="authExpireText" class="ml-2 text-slate-500 text-sm">{{
                    authExpireText
                }}</span>
            </div>
            <a-button
