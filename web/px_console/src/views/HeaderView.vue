...
<template>
    <div class="h-full p-2">
        <div class="h-full flex items-center">
            <span class="!text-xl w-100 font-bold text-slate-700">
                {{ i18n.t("navigation.administration") }} - {{ props.title }}
            </span>
            ...
            <div class="flex justify-end w-full items-center">
                ...
                <a-dropdown trigger="click">
                    <img
                        :src="transIcon"
                        :alt="i18n.t('navigation.language')"
                        :title="i18n.t('navigation.language')"
                ...
                <a-button
                    ...
                    shape="circle"
                    :title="
                        isDark ? i18n.t('navigation.lightTheme') : i18n.t('navigation.darkTheme')
                    "
                    @click="toggleTheme"
                >
                    <template #icon>
