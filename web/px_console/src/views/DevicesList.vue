...
<template>
        ...
        <a-card class="w-full" hoverable>
            <div class="flex">
                ...
                <div class="w-40 flex flex-col items-start">
                    <span class="!h-5"></span>
                    <div class="h-2" />
                    <a-button class="w-20" type="primary" @click="handleSearchDevices"
                        >搜索</a-button
                    >
                </div>
            </div>
                        ...
                        >
                            ...
                            <div class="flex">
                                ...
                                <a-button
                                    size="small"
                                    class="w-10"
                                    @click="handleCopyLink(index, record)"
                                >
                                    复制
                                </a-button>
                            </div>
                ...
                <a-table-column title="创建时间" :min-width="100">
                    <template #default="{ record }">
                        <span class="!text-small">{{
                            formatTimestamp(record.created_timestamp)
                        }}</span>
                    </template>
                </a-table-column>
    ...
    >
        ...
        <div class="flex justify-start">
            ...
            <div>
                <div
                    v-for="(gpu, index) in currentSelectedDevice?.sys_info.gpus"
                    :key="gpu.id || index"
                >
                    <div>
                        >
