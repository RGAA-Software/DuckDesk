...
rem ============================================================================
rem build_gr_auth_server.bat
rem
rem Build and deploy gr_auth_server in one step:
rem   [1/3] Build the Vue frontend   web\gr_auth         (npm run build)
rem   [2/3] Build the Rust server    gr_auth_server      (cargo build --release)
rem   [3/3] Copy artifacts into      output\gr_auth_server\
rem           exe      -> output\gr_auth_server\gr_auth_server.exe
rem           frontend -> output\gr_auth_server\web_auth\
...
rem     use scripts\package_gr_auth_server.bat instead.
...
set "SERVER_NAME=gr_auth_server"
