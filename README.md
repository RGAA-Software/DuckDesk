...
![](docs/gammaray/images/work_directly.png)

#### 2. Relay (转发)
> You can also connect directly in this mode  
> 此模式下亦可直连  

![](docs/gammaray/images/work_relay.png)

## Key Features
### Display multiple screens of remote computers
#### Switch display
![](docs/gammaray/images/multi-screen_switch_display.gif)
#### simultaneous display
![](docs/gammaray/images/multi-screen_switch_imultaneous_display.gif)
### File transfer
#### The transmission speed is very fast
![](docs/gammaray/images/file_trans.gif)
### Transferring files via clipboard
#### The transmission speed is very fast
![](docs/gammaray/images/clipboard_file_trans.gif)

### Screen Recording
#### Supports simultaneous recording on multiple screens
![](docs/gammaray/images/screen_recording.gif)

### Detailed statistical information
![](docs/gammaray/images/statistics.gif)

### Cloud/Remote Game Recordings
#### Wukong/黑神话悟空
![](docs/gammaray/images/test3.gif)
#### Ori/奥日
![](docs/gammaray/images/test1.gif)
#### Elden Ring/埃尔登法环
![](docs/gammaray/images/test2.gif)

### Music Spectrum
![](docs/gammaray/images/spectrum_1.gif)
![](docs/gammaray/images/spectrum_2.gif)
![](docs/gammaray/images/spectrum_3.gif)

### Screenshots
![](docs/gammaray/images/main.jpg)
![](docs/gammaray/images/status.jpg)
![](docs/gammaray/images/game.jpg)
![](docs/gammaray/images/security.jpg)
![](docs/gammaray/images/client.jpg)
![](docs/gammaray/images/file_transfer.jpg)
