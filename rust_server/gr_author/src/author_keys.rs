//登录相关
pub const KEY_AUTHOR_NAME: &str = "author_name";
pub const KEY_AUTHOR_TOKEN: &str = "author_token";

//创建授权相关
pub const KEY_CREATE_AUTHORIZATION_USER_NAME: &str = "name";
pub const KEY_CREATE_AUTHORIZATION_MACHINE_CODE: &str = "machine_code";
