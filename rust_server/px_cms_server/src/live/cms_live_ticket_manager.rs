...
/// Short-lived opaque tickets used by the CMS HLS relay.
///
...
/// secret or its direct playback URL to the CMS web application.
pub struct CmsLiveTicketManager {
    tickets: Mutex<HashMap<String, LivePlayTicket>>,
}

impl CmsLiveTicketManager {
    pub fn new() -> Arc<Self> {
        Arc::new(Self {
