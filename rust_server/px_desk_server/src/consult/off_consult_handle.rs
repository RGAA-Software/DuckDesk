...
pub async fn create_new_consult(
    ...
    consult.created_ts = px_base::get_current_timestamp();
    consult.created_ts_readable = px_base::get_current_readable_timestamp();
    consult.updated_ts = px_base::get_current_timestamp();
    consult.updated_ts_readable = px_base::get_current_readable_timestamp();
