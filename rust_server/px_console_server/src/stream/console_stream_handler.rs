...
use crate::user::console_user_keys::{KEY_PAGE, KEY_PAGE_SIZE, KEY_SORT_DIRECTION, KEY_SORT_FIELD};
use axum::body::Body;
...
pub async fn handle_query_streams(
    State(_ctx): State<Arc<Mutex<ConsoleContext>>>,
    query: Query<HashMap<String, String>>,
) -> Result<Json<RespMessage<Vec<ConsoleStream>>>, ConsoleApiError> {
