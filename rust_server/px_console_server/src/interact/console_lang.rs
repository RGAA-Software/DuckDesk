...
pub struct ConsoleLanguage {
    ...
    pub st_console_state: String,
    pub st_relay_state: String,
    pub st_console_website: String,
    pub st_console_website_https: String,
...
impl ConsoleLanguage {
    pub fn new_english() -> ConsoleLanguage {
        ConsoleLanguage {
            zh_cn: false,
            app_name: "Pixels Console".to_string(),
            copy: "Copy".to_string(),
            ...
            st_console_state: "Manager Server State".to_string(),
            st_relay_state: "Relay Server State".to_string(),
            st_console_website: "Manager Website".to_string(),
            st_console_website_https: "Manager Website(Https)".to_string(),
    ...
    pub fn new_chinese() -> ConsoleLanguage {
        ConsoleLanguage {
            zh_cn: true,
            app_name: "Pixels 管理控制台".to_string(),
            copy: "复制".to_string(),
            update: "更新".to_string(),
            ...
            st_console_state: "管理服务状态".to_string(),
            st_relay_state: "中转服务状态".to_string(),
            st_console_website: "管理端网页".to_string(),
            st_console_website_https: "管理端网页(Https)".to_string(),
