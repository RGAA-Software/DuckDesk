...
CASE WHEN i.kind='rdp' THEN n.rdp_domain END AS rdp_domain,
CASE WHEN i.kind='rdp' THEN n.rdp_proxy_certificate_sha256 END AS rdp_proxy_certificate_sha256
...
AND (i.kind<>'rdp' OR (n.rdp_domain IS NOT NULL AND n.rdp_proxy_certificate_sha256 IS NOT NULL))
