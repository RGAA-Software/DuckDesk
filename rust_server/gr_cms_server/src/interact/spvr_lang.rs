...
pub struct SpvrLanguage {
    ...
    pub st_spvr_state: String,
    pub st_relay_state: String,
    pub st_spvr_website: String,
    pub st_spvr_website_https: String,
...
impl SpvrLanguage {
    pub fn new_english() -> SpvrLanguage {
        SpvrLanguage {
            zh_cn: false,
            ...
            st_spvr_state: "Manager Server State".to_string(),
            st_relay_state: "Relay Server State".to_string(),
            st_spvr_website: "Manager Website".to_string(),
            st_spvr_website_https: "Manager Website(Https)".to_string(),
    ...
    pub fn new_chinese() -> SpvrLanguage {
        SpvrLanguage {
            zh_cn: true,
            ...
            st_spvr_state: "管理服务状态".to_string(),
            st_relay_state: "中转服务状态".to_string(),
            st_spvr_website: "管理端网页".to_string(),
            st_spvr_website_https: "管理端网页(Https)".to_string(),
