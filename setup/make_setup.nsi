...
Function StopAndDeleteService
    ; net stop 是同步的:等服务真正停止后才返回,斩断保活源头
    ; (服务每 3s 拉起 render/UserProxy,UserProxy 每 5s 拉起 panel/SysInfo)
...
Function KillProcesses
	; 顺序:先杀保活者(UserProxy),再杀被保活者;SysInfo 一并处理
