...
namespace px_console
{
    ...
    const std::string kDevicePlatform = "platform";

    class ConsoleDevice {
    public:
        // obj["xx"]
        static std::shared_ptr<ConsoleDevice> FromJson(const std::string& body);

        // obj["xx"]
        static std::shared_ptr<ConsoleDevice> FromObj(const json& obj);
