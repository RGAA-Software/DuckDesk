...
rem     use scripts\package_px_desk_server.bat instead.
...
rem VS 2026 requires explicit C11 mode for stdatomic; this also keeps
rem aws-lc-sys 0.32.x on its direct cc builder instead of the Perl CMake path.
