...
pub struct RelayDeviceInfo {
    ...
    #[prost(string, tag = "3")]
    pub relay_server_ip: ::prost::alloc::string::String,
    #[prost(int32, tag = "4")]
    pub relay_server_port: i32,
    #[prost(string, tag = "5")]
    pub device_w3c_ip: ::prost::alloc::string::String,
    #[prost(string, repeated, tag = "6")]
    pub device_local_ips: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    #[prost(int32, tag = "7")]
    pub device_local_port: i32,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct RelayRequestControlMessage {
    ...
    #[prost(bool, tag = "40")]
    pub force_gdi: bool,
    /// Device password hash verified by the target Render before it admits the
    /// Relay room. This is the same credential used by a direct native session.
    #[prost(string, tag = "50")]
...
pub struct RelayRoomPreparedMessage {
    ...
    /// same with device_id
    #[prost(string, tag = "40")]
    pub creator_device_id: ::prost::alloc::string::String,
    #[prost(string, tag = "50")]
    pub creator_device_name: ::prost::alloc::string::String,
    #[prost(string, tag = "60")]
    pub creator_stream_id: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct RelayRemoteDeviceOfflineMessage {
    #[prost(string, tag = "10")]
    pub room_id: ::prost::alloc::string::String,
    #[prost(string, tag = "20")]
    pub device_id: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct RelayNotificationMessage {
    /// json format
    #[prost(string, tag = "1")]
    pub body: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub from_device: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RelayMessage {
    ...
    pub remote_device_offline: ::core::option::Option<RelayRemoteDeviceOfflineMessage>,
    #[prost(message, optional, tag = "190")]
    pub notification: ::core::option::Option<RelayNotificationMessage>,
}
...
impl RelayMessageType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::KRelayRemoteDeviceOffline => "kRelayRemoteDeviceOffline",
            Self::KRelayNotification => "kRelayNotification",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "kRelayRemoteDeviceOffline" => Some(Self::KRelayRemoteDeviceOffline),
            "kRelayNotification" => Some(Self::KRelayNotification),
            _ => None,
        }
    }
}
