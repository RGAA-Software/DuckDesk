...
#ifndef PX_RENDER_WEBRTC_REMOTE_LIBRARY_H
#define PX_RENDER_WEBRTC_REMOTE_LIBRARY_H
...
namespace px
{
    ...
    private:
        ...
        std::optional<std::reference_wrapper<WebRtcRemoteLibrary>> owner_;
...
#endif  // PX_RENDER_WEBRTC_REMOTE_LIBRARY_H
