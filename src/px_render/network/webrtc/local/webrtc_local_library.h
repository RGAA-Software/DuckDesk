...
#ifndef PX_RENDER_WEBRTC_LOCAL_LIBRARY_H
#define PX_RENDER_WEBRTC_LOCAL_LIBRARY_H
...
namespace px
{
    ...
    private:
        ...
        std::optional<std::reference_wrapper<WebRtcLocalLibrary>> owner_;
    ...
    class WebRtcLocalLibrary : public PxNetPlugin {
    public:
...
#endif  // PX_RENDER_WEBRTC_LOCAL_LIBRARY_H
