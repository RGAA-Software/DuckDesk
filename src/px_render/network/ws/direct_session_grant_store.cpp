...
namespace px {
    ...
    std::string DirectSessionGrantStore::Issue(const DirectSessionGrantBinding& binding,
    ...
    std::string DirectSessionGrantStore::IssueStreamBinding(
    ...
    bool DirectSessionGrantStore::Redeem(const std::string& token,
        ...
        if (found == grants_.end()
            || found->second.binding_.device_id_ != expected.device_id_
            || found->second.binding_.stream_id_ != expected.stream_id_
            || found->second.binding_.client_nonce_ != expected.client_nonce_
