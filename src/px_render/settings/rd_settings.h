...
public:
    bool IsVideoInnerCapture() const { return capture_video_type_ == CaptureVideoType::kVideoInner; }

    bool IsAudioInnerCapture() const { return capture_audio_type_ == CaptureAudioType::kAudioInner; }
...
struct TargetApplication {
    ...
    [[nodiscard]] bool IsGlobalReplayMode() const { return event_replay_mode_ == EventReplayMode::kGlobal; }
...
public:
    [[nodiscard]] bool IsSteamUrl() const { return game_path_.find("steam://") != std::string::npos; }
};
...
public:
    ...
    bool IsGameHookMode() const { return application_mode_ == ApplicationMode::kGameHook; }
    bool IsWebViewMode() const { return application_mode_ == ApplicationMode::kWebView; }
