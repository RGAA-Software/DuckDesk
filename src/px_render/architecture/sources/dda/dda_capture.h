...
class DDACapture : public DesktopCaptureSource, public std::enable_shared_from_this<DDACapture> {
  public:
    ...
    explicit DDACapture(const std::shared_ptr<DdaCaptureSource>& owner, const CaptureMonitorInfo& my_monitor_info);
    virtual ~DDACapture();
    bool Init() override;
