...
namespace px
{
    ...
    class VirtualDesktopBoundRectangleInfo {
    public:
        int far_left_ = 0;
        int far_top_ = 0;
        int far_right_ = 0;
        ...
        [[nodiscard]] std::string Dump() const {
            std::stringstream ss;
            ss << "VirtualDesktopBoundRectangleInfo far_left: " << far_left_ << ", far_top: " << far_top_ << ", far_right: " << far_right_ << ", far_bottom: " << far_bottom_ << std::endl;
            return ss.str();
        }
    };
    ...
    public:
        ...
        [[nodiscard]] bool Valid() const {
            ...
            // Virtual desktop identity is handled by the capture source layer.
