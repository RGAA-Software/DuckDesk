...
//    hlog("Present callback: sync_interval=%u, flags=%u, current_swap=0x%" PRIX64
...
hook_present1(IDXGISwapChain1 *swap, UINT sync_interval, UINT flags, const DXGI_PRESENT_PARAMETERS *params) {
    if (should_passthrough()) {
        dxgi_presenting = true;
        const HRESULT hr =
