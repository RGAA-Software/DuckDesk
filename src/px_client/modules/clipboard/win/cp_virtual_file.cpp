...
namespace px
{
    ...
    CpVirtualFile::CpVirtualFile(
        ...
        module_lifetime_token_ = runtime_bridge
        ...
        if (runtime_bridge) {
            ...
            request_buffer_cbk_ =
                [weak_bridge, token = module_lifetime_token_](
        ...
        if (pformatetcIn->cfFormat == clip_format_filedesc_) {
            ...
            if ((pformatetcIn->tymed & TYMED_ISTREAM)) {
                ...
                auto file_stream = CreateClipboardFileStream(
                    request_buffer_cbk_, module_lifetime_token_, fw);
                {
    ...
    void CpVirtualFile::ReportFileTransferBegin(
        ...
        // Audit and transport are direct typed module services.
        runtime_bridge_->ReportFileTransferBegin(
            stream->GetFileId(), stream->GetFileName(), "In");
