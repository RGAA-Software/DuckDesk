...
namespace px
{
    ...
    static void ToJson(json& j, const ConsoleEvent& e) {
        j = json{
    ...
    static void FromJson(const json& j, ConsoleEvent& e) {
    ...
    std::string ConsoleEvent::AsJson() {
        nlohmann::json j;
        ToJson(j, *this);
        return j.dump();
    }
    ...
    std::shared_ptr<ConsoleEvent> ConsoleEvent::CpuOverload(const std::string& device_id,
                                            const std::string& device_ip,
                                            const std::string& device_name,
                                            const std::string& uid,
                                            const std::string& username,
                                            int cpu_usage) {
        auto event = std::make_shared<ConsoleEvent>();
    ...
    std::shared_ptr<ConsoleEvent> ConsoleEvent::MemoryOverload(const std::string& device_id,
                                                    const std::string& device_ip,
                                                    const std::string& device_name,
                                                    const std::string& uid,
                                                    const std::string& username,
    ...
    std::shared_ptr<ConsoleEvent> ConsoleEvent::DiskOverload(const std::string& device_id,
                                                const std::string& device_ip,
                                                const std::string& device_name,
                                                const std::string& uid,
                                                const std::string& username,
    ...
    std::shared_ptr<ConsoleEvent> ConsoleEvent::GpuOverload(const std::string& device_id,
                                                  const std::string& device_ip,
                                                  const std::string& device_name,
                                                  const std::string& uid,
                                                  const std::string& username,
