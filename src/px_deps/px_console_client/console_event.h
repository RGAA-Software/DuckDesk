...
namespace px
{
    ...
    class ConsoleEvent {
    public:
        static std::shared_ptr<ConsoleEvent> CpuOverload(const std::string& device_id,
        ...
        static std::shared_ptr<ConsoleEvent> MemoryOverload(const std::string& device_id,
                                                         const std::string& device_ip,
                                                         const std::string& device_name,
                                                         const std::string& uid,
                                                         const std::string& username,
        ...
        static std::shared_ptr<ConsoleEvent> DiskOverload(const std::string& device_id,
                                                       const std::string& device_ip,
                                                       const std::string& device_name,
                                                       const std::string& uid,
                                                       const std::string& username,
        ...
        static std::shared_ptr<ConsoleEvent> GpuOverload(const std::string& device_id,
                                                      const std::string& device_ip,
                                                      const std::string& device_name,
                                                      const std::string& uid,
                                                      const std::string& username,
