...
public:
    ...
    HttpResponse Put(const std::map<std::string, std::string>& query, const std::string& body = "", const std::string content_type = "");
    HttpResponse Delete(const std::map<std::string, std::string>& query = {});
    HttpResponse PostMultiPart(const std::map<std::string, std::string>& query, const std::map<std::string, std::string>& form_parts,
                               const std::map<std::string, std::string>& file_parts);
    HttpResponse PutMultiPart(const std::map<std::string, std::string>& query, const std::map<std::string, std::string>& form_parts,
                              const std::map<std::string, std::string>& file_parts);
