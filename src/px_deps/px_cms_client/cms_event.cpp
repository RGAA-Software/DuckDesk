...
namespace px
{
    ...
    static void ToJson(json& j, const CmsEvent& e) {
        j = json{
    ...
    static void FromJson(const json& j, CmsEvent& e) {
    ...
    std::shared_ptr<CmsEvent> CmsEvent::CpuOverload(const std::string& device_id,
                                            const std::string& device_ip,
                                            const std::string& device_name,
                                            const std::string& uid,
                                            const std::string& username,
                                            int cpu_usage) {
        auto event = std::make_shared<CmsEvent>();
    ...
    std::shared_ptr<CmsEvent> CmsEvent::MemoryOverload(const std::string& device_id,
                                                    const std::string& device_ip,
                                                    const std::string& device_name,
                                                    const std::string& uid,
                                                    const std::string& username,
    ...
    std::shared_ptr<CmsEvent> CmsEvent::DiskOverload(const std::string& device_id,
                                                const std::string& device_ip,
                                                const std::string& device_name,
                                                const std::string& uid,
                                                const std::string& username,
    ...
    std::shared_ptr<CmsEvent> CmsEvent::GpuOverload(const std::string& device_id,
                                                  const std::string& device_ip,
                                                  const std::string& device_name,
                                                  const std::string& uid,
                                                  const std::string& username,
