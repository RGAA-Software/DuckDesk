...
#ifndef GAMMARAYPREMIUM_CMS_EVENT_H
#define GAMMARAYPREMIUM_CMS_EVENT_H
...
namespace px
{
    ...
    class CmsEvent {
    public:
        static std::shared_ptr<CmsEvent> CpuOverload(const std::string& device_id,
        ...
        static std::shared_ptr<CmsEvent> MemoryOverload(const std::string& device_id,
                                                         const std::string& device_ip,
                                                         const std::string& device_name,
                                                         const std::string& uid,
                                                         const std::string& username,
        ...
        static std::shared_ptr<CmsEvent> DiskOverload(const std::string& device_id,
                                                       const std::string& device_ip,
                                                       const std::string& device_name,
                                                       const std::string& uid,
                                                       const std::string& username,
        ...
        static std::shared_ptr<CmsEvent> GpuOverload(const std::string& device_id,
                                                      const std::string& device_ip,
                                                      const std::string& device_name,
                                                      const std::string& uid,
                                                      const std::string& username,
...
#endif //GAMMARAYPREMIUM_CMS_EVENT_H