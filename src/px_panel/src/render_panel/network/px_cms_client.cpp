...
namespace px
{
    ...
    void PxCmsClient::HandleRecordListReq(const cms_panel::RecordListReq& req) {
    ...
    void PxCmsClient::HandleRecordFetchReq(const cms_panel::RecordFetchReq& req) {
    ...
    void PxCmsClient::FetchWorkerLoop() {
    ...
    std::string PxCmsClient::UploadRecordFile(const RecordFetchTask& task) {
    ...
    void PxCmsClient::SendRecordFetchDone(const RecordFetchTask& task, bool ok, const std::string& error) {
        cms_panel::CmsPanelMessage msg;
