...
class RunningProcessAdapter(private var context: Context,
                            private var serverEntity: DBServer,
                            private var processes: MutableList<RunningProcess>)
    ...
    override fun onBindViewHolder(holder: RunningProcessHolder, position: Int) {
        ...
        Glide.with(context)
            .load(serverEntity.apiBaseUrl + "/icons/" + process.iconName)
