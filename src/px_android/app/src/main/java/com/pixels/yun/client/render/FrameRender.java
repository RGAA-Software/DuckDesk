...
import com.pixels.yun.client.impl.CursorInfo;
...
public class FrameRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public FrameRender(Context ctx, ThunderApp sdk) {
        ...
        mThunderApp.registerCursorInfoCallback(info -> {
            ...
            if (info.getBitmap() != null) {
                ...
                //Log.i(TAG, "Cursor width: " + info.getWidth() + ", height: " + info.getHeight());
            }
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        if (mCursor != null && Settings.Companion.getInstance().isShowCursor(mContext)) {
            mCursor.render(0);
        }
    }
