...
class SteamAppAdapter(private var context: Context,
                      private var serverEntity: DBServer,
                      private var steamGames: MutableList<SteamGame>) :
    ...
    override fun onBindViewHolder(holder: BookViewHolder, position: Int) {
        ...
        if (position == 0) {
            ...
            val coverUrl: String = if (game.isSteamGame()) {
                serverEntity.apiBaseUrl + "/steam/cache/" + game.gameId
            } else {
                serverEntity.apiBaseUrl + "/" + game.coverName
            }
