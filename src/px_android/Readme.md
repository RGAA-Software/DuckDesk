...
arm64 native 构建以及 APK/AAB 签名校验，并通过 ELF Build ID 保证归档的 native symbols 与 APK 内实际 `.so` 完全对应。脚本把签名证书 SHA-256、
native Build ID、APK、AAB、R8 mapping、native symbols 和带 SHA-256 的发布清单归档到
