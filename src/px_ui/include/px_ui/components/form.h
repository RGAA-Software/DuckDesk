...
[[nodiscard]] bool SearchField(WidgetId id, std::string& value, std::string_view hint = {}, const FieldOptions& options = {});
[[nodiscard]] bool PasswordField(WidgetId id, std::string& value, std::string_view hint = {}, const FieldOptions& options = {});
...
[[nodiscard]] bool ToggleSwitch(WidgetId id, std::string_view label, bool& value, bool disabled = false,
                                std::optional<VectorIcon> icon = std::nullopt);
