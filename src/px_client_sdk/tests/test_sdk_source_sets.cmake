...
file(READ "${sdk_root}/gl/raw_image.h" frame_contents)
if(frame_contents MATCHES "d3d11.h|wrl/|libavutil|AVFrame|ANativeWindow|char[ \t]*\\*|img_buf")
    # Enum names may describe a Windows output but must not expose its resource types.
    string(REPLACE "kRawImageVulkanAVFrame" "kPlatformOutput" frame_contents "${frame_contents}")
    if(frame_contents MATCHES "d3d11.h|wrl/|libavutil|AVFrame|ANativeWindow|char[ \t]*\\*|img_buf")
        message(FATAL_ERROR "Platform resources or raw buffers leaked into the common image header")
    endif()
endif()

file(READ "${sdk_root}/sdk_params.h" parameter_contents)
if(parameter_contents MATCHES "D3D11|AVBufferRef|libavutil|native_window|vulkan_hw|support_vulkan|titlebar_color|language_id")
    message(FATAL_ERROR "Hardware/UI state leaked back into the shared session parameters")
endif()
