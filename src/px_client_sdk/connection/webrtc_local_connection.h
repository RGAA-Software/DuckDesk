...
class WebRtcLocalConnection : public Connection, public std::enable_shared_from_this<WebRtcLocalConnection> {
  public:
    explicit WebRtcLocalConnection(const std::shared_ptr<ThunderSdkParams>& params, const std::shared_ptr<MessageNotifier>& notifier);
