...
const targets = [
  {
    ...
    files: ['px_message.proto', 'px_file_transfer.proto', 'px_signaling_message.proto'],
  },
  {
    dir: 'src/px_web_client/proto',
    files: ['px_message.proto', 'px_file_transfer.proto', 'px_signaling_message.proto', 'px_client_panel_message.proto'],
  },
]
