// Headless screenshot of CMS web /apps page (node feature verification).
// Usage: OUT=/tmp/cms_apps.png EXPAND=1 node scripts/_tmp_cms_apps_shot.mjs
...
const BASE = process.env.CMS_URL || 'https://10.0.0.16:30500'
...
const profile = path.join(os.tmpdir(), `cdp-cms-${Date.now()}`)
