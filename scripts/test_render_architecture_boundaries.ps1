...
$coroutineOwnedClientFiles = @(
    ...
    "src\px_client_sdk\connection\ws_connection.cpp",
    "src\px_client_sdk\connection\wss_connection.cpp"
)
...
$sdkReconnectHelperPath = "src\px_client_sdk\connection\sdk_websocket_reconnect.h"
