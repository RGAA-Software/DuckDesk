...
- **配置文件**：把 `rust_server/px_auth_server/src/gr_auth_server_settings.toml`
  拷到 `/opt/px_auth_server/gr_auth_server_settings.toml`，然后修改：
...
cp -r web/gr_auth/dist/* rust_server/px_auth_server/assets/
```
