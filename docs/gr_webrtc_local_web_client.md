...
- proto:`tc_message.proto`(键鼠/控制)+ `tc_file_transfer.proto`(文件传输)
...
- render 插件日志:`C:/Users/Public/GoDesk/gr_logs/plugin_net_rtc_local.dll.log`
