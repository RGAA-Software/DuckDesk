...
下一代候选拒绝新根”及“新候选丢失旧根链”缺口。5/5 单元测试覆盖多 root 门限/不覆盖、旧新门限轮换、轮换后追加与初始根验证、两代发布与历史保留、历史/当前制品篡改、
错误角色 key 及目标名复用，严格 Clippy 通过。它只生成不可变候选，不上传或切换线上仓库；正式公网同步、轮换发布与水位观察、审批私钥托管和
正式安装包矩阵仍保持门禁。统一验收入口报告 `pg-20260921-190641-d0865e96` 为 5/5，源码 hash 冻结且隔离容器/卷已清理。
