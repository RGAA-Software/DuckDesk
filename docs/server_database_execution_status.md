...
最新完整软件基线 `pg-20260918-181943-2051a284` 在 revision `bef878720` 上为 736/736 项 PASS。它包含 frontend
...
Console 管理端真实浏览器聚焦验收 `pg-20260918-192203-c25eddaa` 的 7/7 项通过。验收启动实际
...
正式产品安装包或公网 Windows/Android 缺口标为完成。提交后必须重跑完整 `Test -Linux`，才可更新完整软件基线。
