...
> 本基线已提交:主仓库 `786388b7`,子模块 `tc_client_sdk_new 95452f7`。
...
- **涉及文件**:`udp_plugin.cpp/h`、`nvenc_video_encoder.cpp`、`tc_client_sdk_new/connection/udp_direct_connection.cpp/h`、`tc_client_sdk_new/sdk_ffmpeg_decoder.cpp`。
