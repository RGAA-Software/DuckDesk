...
- PX Console HTTPS 地址、连接测试、注册、登录和退出。
...
> 本节记录 2026-09-07 实现快照。其中旧的设备内应用页、Panel client type、连接票据、WebRTC/回退和旧端口内容均不是当前实施依据；
> 云应用直接按文首 2026-09-14 决定和专项实施计划替换，不保留兼容行为。
